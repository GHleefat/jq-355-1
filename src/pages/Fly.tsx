...
export default function Fly() {
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-slate-900">
      ...
      {showGuide && (
        <div className="pointer-events-auto absolute inset-0 z-30 flex items-center justify-center cursor-pointer">
          <div className="absolute inset-0 bg-slate-900/55 backdrop-blur-[2px]" />
          <div className="relative z-10 text-center px-10 py-14 rounded-3xl bg-slate-900/60 border border-amber-200/30 shadow-2xl shadow-black/40 max-w-lg">
            ...
            <div className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-amber-200/10 border border-amber-200/30 text-amber-100 tracking-widest animate-pulse">
              点 击 画 面
            </div>
